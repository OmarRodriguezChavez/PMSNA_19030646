...
class DatabaseHelper {
  ...
  Future<bool> findPopular(int id_popular) async {
    var conexion = await database;
  ...
  Future<int> INSERTFAVORITO(String tblName, Map<String, dynamic> data) async {
    var conexion = await database;
    return await conexion.insert(tblName, data);
  }
  Future<int> DELETEFAVORITO(String tblName, int id, String idColumnName) async {
    var conexion = await database;
